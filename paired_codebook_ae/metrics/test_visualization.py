...
def exchange_between_two_dataset_objects(paired_ae, batch, batch_idx):
    ...
    paired_ae.logger.experiment.log({"Image": image[0]})
    paired_ae.logger.experiment.log({"Donor": donor[0]})
    paired_ae.logger.experiment.log({"Recon_like_image": recon_image_like[0]})
    paired_ae.logger.experiment.log({"Recon_like_donor": recon_donor_like[0]})
